...
export const comprarProducto = (idProducto) => {
    ...
    alert(`Usted incorporo el producto ${nombre} \nPor favor haga doble clic en el carrito para continuar`)

}

// Diseñando tabla de carrito e incorporacion a HTML//
const dibujarCarrito = () => {
    ...
    carrito.forEach(producto => {
        ...
        <button id="limpiar${id}" class="btn btn-primary">LimpiarCarrito</button>
        </td>
        `
        ...
        btnlimpiar.addEventListener("click", () => limpiarCarrito(id))
    });
...
//configuracion de precios,cantidades y totales que van dentro de la tabla//
...
const limpiarCarrito = (id) => {
    ...
    carrito[indexProductoCarrito].cantidad = 0
